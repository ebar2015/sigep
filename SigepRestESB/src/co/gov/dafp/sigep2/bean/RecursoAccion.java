 ...
 * @version 1.0
 */
public class RecursoAccion extends ErrorMensajes {
	private static final long serialVersionUID = -599211848245413603L;
	...
	public String toString() {
		return "RecursoAccionDTO [id=" + id + ", padre=" + padre + ", codRecursoAccion=" + codRecursoAccion
				+ ", recurso=" + recurso + ", seccion=" + seccion + ", codRol=" + codRol + ", nombreRol=" + nombreRol
				+ ", descripcionRol=" + descripcionRol + ", total=" + total + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RecursoAccion other = (RecursoAccion) obj;
		if (id != other.id)
			return false;
		return true;
	}
