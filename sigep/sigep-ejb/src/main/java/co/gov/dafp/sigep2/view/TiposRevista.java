 ...
 *
 */
@Entity(name = "TiposRevista")
@Table(name = "V_TIPOS_REVISTA")
@SqlResultSetMappings({ @SqlResultSetMapping(name = TiposRevista.TIPOS_REVISTA_MAPPING, classes = {
		@ConstructorResult(targetClass = TiposRevistaDTO.class, columns = {
...
public class TiposRevista extends VistaBase implements Serializable {
	
	private static final long serialVersionUID = 8202378210619611171L;

	public static final String TIPOS_REVISTA_MAPPING = "co.gov.dafp.sigep2.view.mapping.TiposRevista";
	...
	public VistaBaseDTO getDTO() {
		return new TiposRevistaDTO(id, padre, nombre, valor);
	}
