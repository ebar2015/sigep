...
@Entity(name = "Genero")
@Table(name = "V_GENERO")
@SqlResultSetMappings({ @SqlResultSetMapping(name = Genero.GENERO_MAPPING, classes = {
		@ConstructorResult(targetClass = GeneroDTO.class, columns = {
				@ColumnResult(name = "GENERO_ID", type = Long.class),
				@ColumnResult(name = "SIGLA", type = String.class),
				@ColumnResult(name = "DESCRIPCION", type = String.class) }) }) })
public class Genero extends VistaBase implements Serializable {
	private static final long serialVersionUID = 8202378210619611171L;

	public static final String GENERO_MAPPING = "co.gov.dafp.sigep2.view.mapping.Genero";

	@Id
	@Column(name = "GENERO_ID", unique = true, nullable = false, precision = 38, insertable = false, updatable = false)
	protected Long id;
	...
	public VistaBaseDTO getDTO() {
		return new GeneroDTO(id, sigla, descripcion);
	}
