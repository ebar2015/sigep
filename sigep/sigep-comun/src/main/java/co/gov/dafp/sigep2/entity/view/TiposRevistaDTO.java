...
public class TiposRevistaDTO extends VistaBaseDTO implements Serializable {
	...
	public TiposRevistaDTO() {
		super();
	}

	public TiposRevistaDTO(long id, long padre, String nombre, String valor) {
		super();
		this.id = id;
		this.padre = padre;
		this.nombre = nombre;
