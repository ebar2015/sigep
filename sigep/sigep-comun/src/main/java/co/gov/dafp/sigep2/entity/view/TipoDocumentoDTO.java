...
public class TipoDocumentoDTO extends VistaBaseDTO implements Serializable {
	...
	public TipoDocumentoDTO(long id, String sigla, String descripcion) {
		super();
		this.id = id;
		this.sigla = sigla;
	...
	public String toString() {
		return "TipoDocumentoDTO [id=" + id + ", sigla=" + sigla + ", descripcion=" + descripcion + "]";
	}
