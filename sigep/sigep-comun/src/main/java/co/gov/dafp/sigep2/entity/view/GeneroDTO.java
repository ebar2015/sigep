...
public class GeneroDTO extends VistaBaseDTO implements Serializable {
	...
	public GeneroDTO(long id, String sigla, String descripcion) {
		super();
		this.id = id;
		this.sigla = sigla;
	...
	public String toString() {
		return "GeneroDTO [id=" + id + ", sigla=" + sigla + ", descripcion=" + descripcion + "]";
	}
