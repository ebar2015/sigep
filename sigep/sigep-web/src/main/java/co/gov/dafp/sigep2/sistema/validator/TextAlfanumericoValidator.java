...
@FacesValidator("textAlfanumericoValidator")
public class TextAlfanumericoValidator extends BaseValidator implements Validator, ClientValidator {
	private Pattern textAlfanumericoValidator;
	private static final String TEXT_ALFANUMERICO= ExpresionesRegularesConstants.REGEX_ALFANUMERICO;

	public TextAlfanumericoValidator() {
		textAlfanumericoValidator = Pattern.compile(TEXT_ALFANUMERICO);
	}
	...
	public String getValidatorId() {
		return "textAlfanumericoValidator";
	}
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!textAlfanumericoValidator.matcher(value.toString().trim()).matches()) {
			throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
					MessagesBundleConstants.getStringMessagesBundle(MessagesBundleConstants.DLG_HEADER_MENSAJES,
